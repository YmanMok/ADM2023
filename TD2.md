...
2.1 Normalisation 2.1.1 Raréfaction \#raréfaction -\> prendre en compte
qu’on a un nombre différents de séquences pour chaque échantillon
\#méthodes de normalisation qui permettent de normaliser la table pour
qu’il soient au meme nombre \#La moyenne sera toujours la même (pour
chaque taxa)
...
![](TD2_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
3.2 Barplots empilés \#ce type de graph montre les abondace relatives
des différenets familles \#Le blanc correpsond aux familles qu’on a pas
réussi a identifiées
...
![](TD2_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
4.1.1 Taxonomique compositionnelle \#On crée un table de distance, basé
...
4.1.2 Phylogénétique compositionnelle (unifrac non pondéré) \#Unifrac
est un autre indice de béta-divserité, qui va pondérer l’abondance
relative des asv par leur distance phylogénétique
...
![](TD2_files/figure-gfm/unnamed-chunk-29-1.png)<!-- --> \#PcOA -\>
ordinations \#Séparation entre les communauté du Nord et Sud =\>
différentes \#sur l’autre elles sont plutot proches =\> diminution de la
distance écologique entre les communautés microbiennes \#les ordinations
nous montre une différence entre les communuatés N-S lié au “logiciel”
utilisé
...
![](TD2_files/figure-gfm/unnamed-chunk-31-1.png)<!-- --> \#En général on
prend Ward ou UPGMA parce que ça donne a peu près les mêmes valeurs
...
![](TD2_files/figure-gfm/unnamed-chunk-33-1.png)<!-- --> 5.3 recherche
de clsuetr interprétables
...
![](TD2_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-35-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-35-2.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-37-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-42-1.png)<!-- -->

\#HEAT map-\> présnete toutes les asv dans tous les échantillons \#plus
asv présente -\> rouge et faible -\>bleu \#asv regroupés par crittère
hierarchique \#Clustering hierarchique =\> groupements de celles qui
co-varient ensemble (échn en fonction asv) pas reliés évolutivement mais
par leur profil d’abondance. \#-\> classer en fonction de leur
distribution en asv
...
![](TD2_files/figure-gfm/unnamed-chunk-44-1.png)<!-- -->

2èm HEATmap \#comparer les éch en tre en fonction des asv -\> quels
échan plus proches \#-\>classer en fonction : même profils d’asv

5.4.6 Ajouter un boxplot de la distribution de l’abondance de l’ASV dans
l’échantillon
...
![](TD2_files/figure-gfm/unnamed-chunk-45-1.png)<!-- --> 6.1.1 Nombre de
PC à conserver
...
![](TD2_files/figure-gfm/unnamed-chunk-46-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-49-1.png)<!-- --> 6.1.3
...
![](TD2_files/figure-gfm/unnamed-chunk-50-1.png)<!-- -->

6.1.4 Corréler les principales composantes avec les données
environnementales
...
![](TD2_files/figure-gfm/unnamed-chunk-51-1.png)<!-- --> 6.2 Analyse en
composantes principales (PCoA)
...
![](TD2_files/figure-gfm/unnamed-chunk-53-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-55-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-56-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-59-1.png)<!-- --> 7.1 Analyse
multiple PERmutationnelle de la variance (PERMANOVA)
...
![](TD2_files/figure-gfm/unnamed-chunk-62-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-67-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-81-1.png)<!-- --> 8.2 Régression
multiple sur matrices de dissimilarité (MRM)
...
![](TD2_files/figure-gfm/unnamed-chunk-87-1.png)<!-- -->
...
![](TD2_files/figure-gfm/unnamed-chunk-89-1.png)<!-- -->

9.2 Analyse différentielle des compositions de microbiomes avec
correction des biais (ANCOM-BC)
...
![](TD2_files/figure-gfm/unnamed-chunk-91-1.png)<!-- -->
...
```
    ...
    ## marker1   ASV27        North 1.785232 0.0004327147 0.03172728
